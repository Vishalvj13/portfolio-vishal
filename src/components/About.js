                ...
                >
                    {/* About Text */}
                     <p className="about-text">
                        ...
                        <br /><br />
                        My work revolves around securing enterprise cloud environments — from analyzing threat reports and <strong><em>AWS Config</em></strong> findings to building <strong><em>Policy-as-Code</em></strong> frameworks💫. I love architecting remediation engines, automating compliance in <strong><em>CI/CD</em></strong> pipelines, and making the cloud a safer, smarter place.
                        <br /><br />
